        ...
        <div>
            ...
            <form method="POST" action="/image">
                ...
                <textarea name="description" id="description" cols="30" rows="5"
                    class="border border-gray-600 rounded text-xs p-2" placeholder="A beagle barking at a squirrel in a tree..."></textarea>
            ...
            @if (count($messages))
                <div class="space-y-6">
                    ...
                    <form action="/resetImage" method="POST">
                        @csrf
                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Reset Image</button>
                    </form>
                </div>
            @else
